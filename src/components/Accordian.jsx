          ...
          <div className="accordion accordion-flush" id="accordionFlushExample">
              <div className="accordion-item">
                  ...
                  <div id="flush-collapseOne" className="accordion-collapse collapse"
                      ...
                      <div className="accordion-body">Placeholder content for this accordion, which
              ...
              <div className="accordion-item">
                  ...
                  <div id="flush-collapseTwo" className="accordion-collapse collapse"
                      ...
                      <div className="accordion-body">Placeholder content for this accordion, which
                          is intended to demonstrate the <code>.accordion-flush</code> class. This
                          is the second item's accordion body. Let's imagine this being filled with
                          some actual content.
                      </div>
                  </div>
              </div>
              <div className="accordion-item">
                  ...
                  <div id="flush-collapseThree" className="accordion-collapse collapse"
                      ...
                      <div className="accordion-body">Placeholder content for this accordion, which
                          ...
                          least at first glance, a bit more representative of how this would look in
